...
# Serve static files straight from each app's static/ dir, so the deploy does
# not depend on a collectstatic step having run. Avoids a hard 500 when
# /app/staticfiles is missing on the container.
